...
<br>If you&#8217;d like the output to be easier to read use this command:
...
<li>Now setup a Cron job using crontab, enter this command: <strong>&#8216;crontab –e&#8217;</strong><br />
And use this code to run the public-ip-update.sh every hour:</p>
`0 * * * * /<strong>PATHTOYOURFILE</strong>/public-ip-update.sh`
<p>You can push through an update immediately to test by running:</p>
`'bash /<strong>PATHTOYOURFILE</strong>/public-ip-update.sh'`
