...
1. **'RSA and RSA'** – You could select 'ECC (sign and encrypt)', but RSA is more widely supported and has been around much longer.
2. **Key size:** '4096'
...
> 🚨 **Note:** Throughout the next steps, this key identifier will be used in the examples. If you're running these commands for yourself, replace `171UN2R685ITSJFW` with your key.
