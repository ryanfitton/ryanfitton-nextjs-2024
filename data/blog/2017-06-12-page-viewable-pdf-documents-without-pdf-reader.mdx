\-\-- layout: PostLayout title: \"In-page embedded viewable PDF documents without a PDF reader\" authors: \[\'Ryan Fitton\'\] date: \'2017-06-12\' tags: \[\'Development\', \'Code Snippets\'\] draft: false summary: \'Here is a neat trick which I&#8217;ve found: using a tool by Google named Docs Viewer you can embed PDF (Or office and Postscript) files into a webpage to be viewed on screen, even without a PDF reader plugin installed in the user&#8217;s browser. Simply use the snippet below and change where your_document_here is mentioned twice \[&hellip;\]\' \-\--
...
Simply use the snippet below and change where `your_document_here`{.language-html} is mentioned twice with a full URL, e.g. https://example.com/doc.pdf.
