\-\-- layout: PostLayout title: \"Installing TP-Link Omada Controller on Ubuntu\" authors: \[\'Ryan Fitton\'\] date: \'2020-10-31\' tags: \[\'Uncategorized\'\] draft: false summary: \'I have a bunch of TP-Link EAP model WiFi access points in my home, these are enterprise grade devices allow management via a unified controller, TP-Link call their controller software Omada. This is very similar to Ubiquiti&#8217;s Unifi controller. Whilst I don&#8217;t have any other Unifi equipment, I found the TP-Link access points to be \[&hellip;\]\' \-\--

[![](/static/img/blog/2020/10/omada_screenshot_1-300x146.png){loading="lazy" width="300" height="146" srcset="/static/img/blog/2020/10/omada_screenshot_1-300x146.png 300w, /static/img/blog/2020/10/omada_screenshot_1-1024x499.png 1024w, /static/img/blog/2020/10/omada_screenshot_1-768x374.png 768w, /static/img/blog/2020/10/omada_screenshot_1.png 1284w" sizes="(max-width: 300px) 100vw, 300px"}](/static/img/blog/2020/10/omada_screenshot_1.png)I have a bunch of [TP-Link EAP](https://www.amazon.co.uk/s/ref=as_li_ss_tl?k=tp+link+eap&ref=nb_sb_noss&linkCode=ll2&tag=ryanfittoncou-21&linkId=d7f0af7e347cffc0ba512d7e3b06e1c2&language=en_GB) model WiFi access points in my home, these are enterprise grade devices allow management via a unified controller, TP-Link call their controller software [Omada](https://www.tp-link.com/uk/omada/).
...
[![](/static/img/blog/2020/10/omada_screenshot_2-300x144.png){loading="lazy" width="300" height="144" srcset="/static/img/blog/2020/10/omada_screenshot_2-300x144.png 300w, /static/img/blog/2020/10/omada_screenshot_2-1024x491.png 1024w, /static/img/blog/2020/10/omada_screenshot_2-768x368.png 768w, /static/img/blog/2020/10/omada_screenshot_2.png 1308w" sizes="(max-width: 300px) 100vw, 300px"}](/static/img/blog/2020/10/omada_screenshot_2.png)This tutorial will install the Omada controller on Ubuntu. In my case, this was Ubuntu 18.04, and the Omada Controller version v3.2.10.
...
1.  1.  Update your packages:
    ...
    6.  Now, we have installed the prerequisites, you now need to download the Omada controller package.In this tutorial the '.deb' packages will be installed, these offer the most easiest way to install the Omada controller software.
        ...
        Download the latest Omada controller software from TP-Link's website here: [https://www.tp-link.com/uk/support/download/omada-software-controller/#Controller_Software](https://www.tp-link.com/uk/support/download/omada-software-controller/#Controller_Software){target="_blank" rel="noopener noreferrer"}.
