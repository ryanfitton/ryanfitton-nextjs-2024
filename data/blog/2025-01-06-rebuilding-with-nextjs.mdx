...
6. Due to adding a separate 'portfolio' section, I also had to update the [Sitemap](https://ryanfitton.co.uk/sitemap.xml) and [RSS feed](https://ryanfitton.co.uk/feed.xml) generation script to include posts from this new section.
