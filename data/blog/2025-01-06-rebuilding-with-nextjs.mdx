...
6. Due to adding a separate 'portfolio' section, I also had to update the [Sitemap](/blog/sitemap.xml) and [RSS feed](/blog/feed.xml) generation script to include posts from this new section.
