\-\-- layout: PostLayout title: \"PHP: Finding a multi-dimensional array key&#8217;s associated value\" authors: \[\'Ryan Fitton\'\] date: \'2018-01-05\' tags: \[\'Development\', \'Code Snippets\'\] draft: false summary: \'I thought I would share this simple PHP function to hopefully help anyone needing a quick solution. Imagine, you have a multi-dimensional array such as this: &lt;?php //Example array \$array = array( \'test\' =&gt; array( \'name\' =&gt; \'John Doe\', \'email\' =&gt; \'john@example.com\' ) ); ?&gt; And you need to extract a specific bit of data, \[&hellip;\]\' \-\--
