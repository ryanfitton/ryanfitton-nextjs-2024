...
<p>
  When building WordPress themes, there is often a need to use a featured thumbnail, or image value
  from ACF; as either a background image or as a &lt;img&gt; tag.
</p>
<p>
  This snippet below is something I use frequently, hopefully this will be as benefit for you too.
</p>
``` &lt;?php //Custom image sizes - Add these to your functions.php add_image_size(
'custom_image_size_1', 650, 650, false ); add_image_size( 'custom_image_size_2', 300, 300, false );
?&gt;
