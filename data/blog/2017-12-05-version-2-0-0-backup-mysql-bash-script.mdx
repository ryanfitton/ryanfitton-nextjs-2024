...
<p>
  This is similar post to be read together with{' '}
  <a href="https://ryanfitton.co.uk/blog/backup-server-files-as-tar-gz-bash-script-version-2/">
    this
  </a>
  . And a follow-up update to &#8216;
  <a href="https://ryanfitton.co.uk/blog/backup-mysql-bash-script/">
    Backup SQL files to FTP server
  </a>
  &#8216; script.
</p>
<p>
  Some of my similar Backup scripts reside in a a GitHub here:{' '}
...
<ul>
  ...
  <li>
    Uses &#8216;<a href="https://linux.die.net/man/1/lftp">lftp</a>&#8216; to upload files via FTP.
    Lftp allows multi-level directories to be created on the server.
  </li>
