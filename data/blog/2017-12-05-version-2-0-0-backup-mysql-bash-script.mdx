...
This is similar post to be read together with [this](/blog/blog/backup-server-files-as-tar-gz-bash-script-version-2/). And a follow-up update to '[Backup SQL files to FTP server](/blog/blog/backup-mysql-bash-script/)' script.
