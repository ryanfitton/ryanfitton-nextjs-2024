...
draft: false
summary: 'This is a follow-up post with an update to the &#8216;Backup Files as
Tar.GZ&#8216; script. Some of my similar Backup scripts reside in a a
GitHub here:
...
to upload files via FTP. Lftp allows ...'
---

This is a follow-up post with an update to the '[Backup Files as
