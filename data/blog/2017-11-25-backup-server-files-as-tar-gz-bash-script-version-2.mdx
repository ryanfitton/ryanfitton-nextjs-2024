\-\-- layout: PostLayout title: \"Version 2.0.0: Backup server files as tar.gz (Bash script)\" authors: \[\'Ryan Fitton\'\] date: \'2017-11-25\' tags: \[\'Development\', \'Code Snippets\'\] draft: false summary: \'This is a follow-up post with an update to the &#8216;Backup Files as Tar.GZ&#8216; script. Some of my similar Backup scripts reside in a a GitHub here: https://github.com/ryanfitton/lxc-mysql-tar-backup-script-collection Version 2.0.0, now adds additional features and bug fixes: Now searches to ensure the required packages are installed. Uses &#8216;lftp&#8216; to upload files via FTP. Lftp allows \[&hellip;\]\' \-\--
