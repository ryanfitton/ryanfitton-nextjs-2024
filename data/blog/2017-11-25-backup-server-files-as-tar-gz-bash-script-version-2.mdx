...
BACKUP*FILES='/' # Files to include within the backup.
FILENAME_PREFIX='full-backup*' # Prefix for the .tar.gz filename. The script will automatically append the server hostname and today's datetime.
