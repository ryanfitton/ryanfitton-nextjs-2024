...
<p>
  If you&#8217;re editing a website but only have theme access, and no access to the database, you
  can temporarily add the code below into your theme &#8216;front-page.php&#8217; or other theme
...
``` &lt;?php /************************ * Change an existing WordPress user email address
***********************/
