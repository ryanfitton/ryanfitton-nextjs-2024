...
<p>To add more videos, increment the &#8216;0&#8217; in <code class="language-html">id=&quot;vid-0&quot;</code> and add the YouTube video&#8217;s ID to the <code class="language-html">data-id&quot;xxx&quot;</code> variable.</p>
...
<pre class="language-scss"><code class="language-scss">section {
    margin:25px 0;
}
