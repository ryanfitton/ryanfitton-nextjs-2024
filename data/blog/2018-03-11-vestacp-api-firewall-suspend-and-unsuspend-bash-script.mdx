...
<ol>
    ...
    <li>Save the file as `firewall-change.sh`</li>
    <li>Make the file executable by running `chmod +x firewall-change.sh`</li>
    <li>Now you can run the the file with `./firewall-change.sh`</li>
</ol>
<p>&nbsp;</p>
