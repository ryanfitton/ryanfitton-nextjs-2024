...
export default function Header() {
  ...
  const subTitle = (pathnameSplit[2] ? pathnameSplit[2].replace(/-/g, ' ').replace(/(?:^|\s)\S/g, a => a.toUpperCase()) : '')
            ...
            <div className="hero hero--page">
                <div className="hero__container site-container">
                    <div className="hero__content">
                        {(title && subTitle) ? (
                            <>
                                <PageTitle className="component-title--homepage">{subTitle}</PageTitle>
                                <PageTitle headingSize="h3" className="component-title--sub">{title}</PageTitle>
                            </>
                        ) : (
                            <>
                                <PageTitle className="component-title--homepage">{title}</PageTitle>
                            </>
                        )}
                    </div>
                </div>
